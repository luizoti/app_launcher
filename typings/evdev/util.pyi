...
def list_devices(input_device_dir: str | None = ...) -> list[str]:
...
def categorize(event: InputEvent) -> KeyEvent:
    """
...
def resolve_ecodes_dict(
    typecodemap, unknown=...
):  # -> Generator[tuple[tuple[Any, Any], list[Any]], Any, None]:
    """
