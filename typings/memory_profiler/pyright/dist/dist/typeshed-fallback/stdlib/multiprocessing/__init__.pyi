...
class Finalize(Generic[_R_co]):
    @overload
    def __init__(self, obj: None, callback: Callable[..., _R_co], *, args: Sequence[Any] = ..., kwargs: Mapping[str, Any] | None = ..., exitpriority: int) -> None:
        ...
    ...
    @overload
    def __init__(self, obj: Any, callback: Callable[..., _R_co], args: Sequence[Any] = ..., kwargs: Mapping[str, Any] | None = ..., exitpriority: int | None = ...) -> None:
        ...
    
    def __call__(self, wr: Unused = ..., _finalizer_registry: MutableMapping[Incomplete, Incomplete] = ..., sub_debug: Callable[..., object] = ..., getpid: Callable[[], int] = ...) -> _R_co:
        ...
