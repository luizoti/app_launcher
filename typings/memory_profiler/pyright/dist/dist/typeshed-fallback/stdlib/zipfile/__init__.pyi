...
from typing import Final, IO, Literal, Protocol, overload, type_check_only
...
class ZipFile:
    ...
    if sys.version_info >= (3, 11):
        ...
        @overload
        def __init__(self, file: StrPath | IO[bytes], mode: _ZipFileMode = ..., compression: int = ..., allowZip64: bool = ..., compresslevel: int | None = ..., *, strict_timestamps: bool = ...) -> None:
            ...
        
        @overload
        def __init__(self, file: StrPath | _ZipReadable, mode: Literal["r"] = ..., compression: int = ..., allowZip64: bool = ..., compresslevel: int | None = ..., *, strict_timestamps: bool = ...) -> None:
            ...
        
        @overload
        def __init__(self, file: StrPath | _ZipWritable, mode: Literal["w", "x"], compression: int = ..., allowZip64: bool = ..., compresslevel: int | None = ..., *, strict_timestamps: bool = ...) -> None:
            ...
        
        @overload
        def __init__(self, file: StrPath | _ZipReadableTellable, mode: Literal["a"], compression: int = ..., allowZip64: bool = ..., compresslevel: int | None = ..., *, strict_timestamps: bool = ...) -> None:
            ...
...
if sys.version_info >= (3, 12):
    ...
    class Path:
        ...
        @overload
        def open(self, mode: Literal["r", "w"] = ..., encoding: str | None = ..., errors: str | None = ..., newline: str | None = ..., line_buffering: bool = ..., write_through: bool = ..., *, pwd: bytes | None = ...) -> TextIOWrapper:
            ...
        
        @overload
        def open(self, mode: Literal["rb", "wb"], *, pwd: bytes | None = ...) -> IO[bytes]:
            ...
