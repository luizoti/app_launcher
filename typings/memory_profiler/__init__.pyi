...
class MemitResult:
    ...
    def __init__(
        self, mem_usage, baseline, repeat, timeout, interval, include_children
    ) -> None: ...
...
class MemTimer(Process):
    ...
    def __init__(
        self, monitor_pid, interval, pipe, backend, max_usage=..., *args, **kw
    ) -> None: ...
    def run(self):  # -> None:
        ...
...
class CodeMap(dict):
    ...
    def items(
        self,
    ):  # -> Generator[tuple[Any, Generator[tuple[Any, Any], None, None]], Any, None]:
...
class LineProfiler:
    ...
    ):  # -> Callable[..., TraceFunction] | Callable[..., ...]:
        ...
...
def profile(
    func=..., stream=..., precision=..., backend=...
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Awaitable[Any]] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Awaitable[Any] | Any] | Callable[..., ...]:
    """
